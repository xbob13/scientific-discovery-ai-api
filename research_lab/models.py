...
class DatasetDefinition(Base):
    ...
    access_tier: Mapped[str] = mapped_column(String(40), default="public")
    license_summary: Mapped[str] = mapped_column(Text)
    redistribution_policy: Mapped[str] = mapped_column(String(80), default="metadata_only")
...
class ClientWorkspace(Base):
    ...
    portal_token_sha256: Mapped[str] = mapped_column(String(64))
...
class IntelligenceBrief(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    workspace_id: Mapped[str] = mapped_column(ForeignKey("client_workspaces.id"), index=True)
    topic_id: Mapped[str] = mapped_column(ForeignKey("client_topics.id"), index=True)
    cycle_key: Mapped[str] = mapped_column(String(200))
    title: Mapped[str] = mapped_column(Text)
